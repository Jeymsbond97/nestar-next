...
import { MemberInquery } from '../../../libs/types/member/member.input';
...
const AdminUsers: NextPage = ({ initialInquiry, ...props }: any) => {
	...
	const [membersInquiry, setMembersInquiry] = useState<MemberInquery>(initialInquiry);
					...
					<TabContext value={value}>
						<Box component={'div'}>
							<List className={'tab-menu'}>
								<ListItem
									onClick={(e: ReactEventHandler) => tabChangeHandler(e, 'ALL')}
									value="ALL"
								...
								<ListItem
									onClick={(e: ReactEventHandler) => tabChangeHandler(e, 'ACTIVE')}
									value="ACTIVE"
								...
								<ListItem
									onClick={(e: ReactEventHandler) => tabChangeHandler(e, 'BLOCK')}
									value="BLOCK"
								...
								<ListItem
									onClick={(e: ReactEventHandler) => tabChangeHandler(e, 'DELETE')}
									value="DELETE"
